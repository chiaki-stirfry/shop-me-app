...
public class ProductRepositoryTest {
	...
	public void testsaveProductDetails() {
		...
		ProductDetail detail1 = new ProductDetail(product);
		detail1.setName("Computer Memory Size");
		detail1.setValue("8 GB");
		
		ProductDetail detail2 = new ProductDetail(product);
		detail2.setName("CPU Model Manufacturer");
		detail2.setValue("Intel");
		
		
		List<ProductDetail> listProductDetails = new ArrayList<>();
		listProductDetails.add(detail1);
		listProductDetails.add(detail2);
		
		product.setDetails(listProductDetails);
